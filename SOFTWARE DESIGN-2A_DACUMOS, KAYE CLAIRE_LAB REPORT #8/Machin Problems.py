...
label = Label(root, text='TEMPERATURE CONVERTER', font=('Arial', 45))
label.pack(side=TOP)

label1 = Label(root, text='Temperature in Celsius =', font=('Arial', 30))
label1.place(x=200, y=200)

label2 = Label(root, text='Temperature in Fahrenheit =', font=('Arial', 30))
